      ...
      <nav className="bg-white dark:bg-gray-800 shadow-sm py-4 sticky top-0 z-50 transition-colors duration-300 glassmorphism">
        <div className="container mx-auto px-4 md:px-6 flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            <div className="flex items-center">
              <button 
                ...
                className="theme-toggle-btn flex items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300"
          ...
          <div className="md:hidden flex items-center space-x-4">
            ...
            <button 
              onClick={toggleDarkMode} 
              className="theme-toggle-btn flex items-center justify-center w-9 h-9 rounded-full bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 transition-all duration-300"
              aria-label="Toggle Dark Mode"
            >
              {darkMode ? (
                <svg 
